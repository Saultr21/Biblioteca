...
@section("tabla")
    ...
    <div class="d-flex justify-content-between mb-2">
        <form action="../../../Biblioteca/admin/editorial/index.php" method="post">
        ...
        <p><a class="btn btn-success btn-sm" href="../../../Biblioteca/admin/editorial/nuevo.php"><i class="fa fa-plus-circle" aria-hidden="true"> Crear</i></a>
        </p>
    </div>
    <table class="table table-striped table-bordered">
        ...
        @foreach ($datos as $dato => $valor)
            <tr>
                ...
                <td><a class="btn btn-primary btn.sm" href="../../../Biblioteca/admin/editorial/modificar.php?id_editorial={{$valor['id_editorial']}}"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                <td><a class="btn btn-danger btn.sm" onclick="alerta()"
                       href="../../../Biblioteca/admin/editorial/borrar.php?id_editorial={{$valor['id_editorial']}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
        @endforeach
    </table>
